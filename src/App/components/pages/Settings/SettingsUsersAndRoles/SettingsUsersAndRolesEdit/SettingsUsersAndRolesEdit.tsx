...
import './SettingsUsersAndRolesEdit.scss';

export const SettingsUsersAndRolesEdit = () => {
    ...
    return (
        <div className="usersandroles__edit">
            ...
            <div className="password">
                <div className="password__current">
                    <span className="current__label p--md--normal">Текущий пароль</span>
                    <Inputs
                        name="current_password"
                        type="text"
                        onInputChange={inputHandler}
                        value={inputsState.current_password}
                        placeholder="Введите пароль"
                    />
                </div>
                <div className="password__new p--md--normal">
                    <span className="new__label p--md--normal">Новый пароль</span>
                    <Inputs
                        name="new_password"
                        type="text"
                        onInputChange={inputHandler}
