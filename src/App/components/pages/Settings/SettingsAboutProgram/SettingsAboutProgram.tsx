...
import { LogoIms } from 'assets/images/svgr/logo_ims';
...
import { CustomScrollbar } from '../../../global/CustomScrollbar/CustomScrollbar';
                ...
                <div className="about__programm__wrapper">
                    ...
                    <div className="about__programm__body">
                        <section className="software" onClick={softwareHandler}>
                            {/* <CustomScrollbar> */}
                            <div
                                data-license="carddexLicense"
                                className="software__ims p--md--bold iconblock  selected">
                                <LicenseLogo />
