...
import { triggerDevices } from 'redux/SecurityPost/SecurityPostCentral/securityPostCentralAction';
                    ...
                    <div className="access-point-control__general">
                        <div className="access-point__description">
                            <div className="access-point__description-left">
                                <div
                                    className={`access-point__description-elem ${
                                        selectedDevice.enabled ? 'active' : 'inactive'
                                    }`}>
                                    <div
                                        className={`access-point__description-elem-icon ${
                                            selectedDevice.enabled ? 'active' : 'inactive'
                                        }`}>
                            ...
                            <div className="access-point__description-right">
                                <div className="access-point__description-elem">
                                    ...
                                    <div className="p--md--bold">
                                        {selectedDevice.controllerTypeName
                                            ? selectedDevice.controllerTypeName
                                            : '_______'}
                                    </div>
                                </div>
                        ...
                        <div className="access-point__button">
                            <Buttons
                                ...
                                typical
                                onPress={() => dispatch(triggerDevices(selectedDevice))}
                            />
                        </div>
                    </div>
                )}
