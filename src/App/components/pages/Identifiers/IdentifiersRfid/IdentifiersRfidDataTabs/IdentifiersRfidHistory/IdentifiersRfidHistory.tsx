...
import './IdentifiersRfidHistory.scss';

const IdentifiersRfidHistoryInner = () => {
    return (
        <div className="identifiers-rfid-history">
...
export const IdentifiersRfidHistory = memo(IdentifiersRfidHistoryInner);
