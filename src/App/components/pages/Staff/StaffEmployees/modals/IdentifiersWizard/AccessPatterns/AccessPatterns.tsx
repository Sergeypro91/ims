...
import { staffEmployeesSetupWizardAccesZones } from 'redux/Staff/StaffEmployees/staffEmployeesAction';
...
const AccessPatternsInner = () => {
    ...
    const initialPatterns = [
        {
            ...
            name: 'Общий шаблон',
            description:
                'Этот шаблон позволяет сотруднику  свободно проходить в такие зоны как “Производство”, “Отдел разработки”',
    ...
    useEffect(() => {
        ...
        dispatch(
            staffEmployeesSetupWizardAccesZones(
                        ...
                        {patterns.map((elem) => {
                            return (
                                <Accordion
                                    ...
                                    type="selectable"
                                    header={elem.name}
                                    activator={() => selectItem(elem.index)}
