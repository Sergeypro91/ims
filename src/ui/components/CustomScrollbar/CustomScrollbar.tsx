...
const CustomScrollbarInner = (props: CustomScrollbarState) => {
    ...
    const scrolTo = useCallback((e: React.PointerEvent) => {
        const scrollHostElement = scrollHostRef.current;
    ...
    useEffect(() => {
        ...
        document.addEventListener('pointerleave', handleDocumentMouseUp);
        ...
        return () => {
            ...
            document.removeEventListener('pointerleave', handleDocumentMouseUp);
        };
        ...
        >
            ...
            {ifScrollAreaSmall && (
                <div
                    ...
                    onWheel={scrollCatch}
                    onPointerDown={scrolTo}
                >
                    <div
                        className="scroll-thumb"
                        style={{ height: scrollBoxHeight, top: scrollBoxTop }}
                        onPointerDown={handleScrollThumbMouseDown}
                    />
                </div>
            )}
        </div>
