...
const QuickIssueRfidWizardInner = () => {
    const modalName = 'quick-issue-rfid-wizard';
    ...
    }, [identifiersRfid.key, identifiersGeneral.limits]);
...
export const QuickIssueRfidWizard = memo(QuickIssueRfidWizardInner);
