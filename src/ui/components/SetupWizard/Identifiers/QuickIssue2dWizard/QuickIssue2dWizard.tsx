...
const QuickIssue2dWizardInner = () => {
    const modalName = 'quick-issue-2d-wizard';
    ...
    const { identifiersGeneral, identifiersQr } = useSelector((state: State) => state.identifiers, shallowEqual);
...
export const QuickIssue2dWizard = memo(QuickIssue2dWizardInner);
