    ...
    return (
        ...
        >
            <div className="custom-input__label">
                {props.label && (
                    <label style={props.labelStyles} className="custom-input__label-title">
                        <div className="p--sm--normal">{props.label}</div>
                    </label>
                )}
                <div className="custom-input__label-required">{props.required && <div className="p--sm--normal">*</div>}</div>
            </div>
            ...
            <div ref={inputWrapper} className="custom-input__wrapper" tabIndex={-1}>
                ...
                {props.name === 'password' ? (
                    <div className="custom-input__specific-action custom-input__specific-action--show-hide" onClick={changeTypePassword}>
                        {inputType === 'password' ? <Show /> : <Hide />}
                    </div>
                ) : null}

                {props.name === 'search' ? (
                    <div className="custom-input__specific-action custom-input__specific-action--search" onClick={props.search}>
                        <Search />
                    </div>
                ) : null}
