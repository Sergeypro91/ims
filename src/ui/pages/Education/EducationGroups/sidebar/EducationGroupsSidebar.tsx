...
import { EGToggleIsSidebarOpened } from 'redux/Education/EducationGroups/educationGroupsActions';
...
const EducationGroupsSidebar = () => {
    const dispatch = useDispatch();
    const { isSidebarOpened, selectedRow } = useSelector((state: State) => state.education.educationGroups, shallowEqual);

    return (
        <Sidebar
            label="Данные о группе"
            icon="Groups"
            isOpen={isSidebarOpened}
            toggleIsOpen={() => dispatch(EGToggleIsSidebarOpened())}
            deletedBadgeActive={
                // @ts-ignore
                ...
                <Tab header="Общие" index={0}>
                    <div className="sidebar__wrapper">
                        {selectedRow ? (
                            <>
                                <SidebarBlock>
                                    <SidebarHeader>Наименование группы</SidebarHeader>
                                    <SidebarValue>{selectedRow.depName || nbsp}</SidebarValue>
                                </SidebarBlock>
                                <SidebarBlock>
                                    <SidebarHeader>Куратор группы</SidebarHeader>
                                ...
                                <SidebarBlock>
                                    ...
                                    <SidebarValue>{selectedRow.tribuneName || nbsp}</SidebarValue>
                                </SidebarBlock>
                                <SidebarBlock>
...
export default EducationGroupsSidebar;
