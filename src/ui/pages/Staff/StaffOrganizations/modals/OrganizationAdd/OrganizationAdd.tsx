...
import { SOAddOrganization } from 'redux/Staff/StaffOrganizations/staffOrganizationsActions';
...
const OrganizationAdd = () => {
    ...
    return (
        <Modal
            ...
            onSuccessClick={() => dispatch(SOAddOrganization(inputsState, closeCurrentModal))}
