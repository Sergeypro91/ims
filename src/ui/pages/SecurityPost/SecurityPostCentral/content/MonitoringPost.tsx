...
import { securityPostCentralGetEvents, requestEvents } from 'redux/SecurityPost/SecurityPostCentral/securityPostCentralAction';
// import {
...
const MonitoringPostInner = () => {
    ...
    const { event, status } = useSelector((state: State) => state.app.wsEvent, shallowEqual);
