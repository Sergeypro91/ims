...
const TabGeneralInner = () => {
    const [equipmentsList] = useState(['Контроллер 1', 'Контроллер 2', 'Контроллер 3']);
    ...
    return (
        <div className="sidebar-tab sidebar-tab--setup-equip-general">
            <div className="sidebar-tab__group">
                ...
                />
                <Inputs name="equipmentsPort" label="Порт" onInputChange={inputHandler} type="text" value={inputsState.equipmentsPort} />
                <Inputs
